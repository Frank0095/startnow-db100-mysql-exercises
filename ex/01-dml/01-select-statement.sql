...
# Write a query to retrieve all rows and all columns from the actors table.


# Write a query to retrieve all rows and only the last_name column from the actors table.
